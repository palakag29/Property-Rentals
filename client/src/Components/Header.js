  ...
  return (
      <header className='flex justify-between px-8 pt-4'>
          ...
          <div className='flex items-center gap-2 '>
              <Link to={'/add-property'} className="py-2 px-4 rounded-3xl hover:bg-grey font-bold"> Airbnb your home</Link>
              <Link to={'/login'} className="flex p-2 items-center gap-2 border border-gray-300 rounded-full py-2 px-4 ">
